...
const titleTask = document.querySelector('#input_title') as HTMLInputElement;
const typeTask = document.querySelector(
...
class DOMManipulator {
  ...
  createElement(element: string, classlist?: string): HTMLElement {
  ...
  addTypeToTask(typeTask: string): HTMLElement {
  ...
  createTaskItem({ title, type }: Task): HTMLElement {
  ...
  removeTask(element: HTMLButtonElement, index: number): void {
